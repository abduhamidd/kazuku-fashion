...
import SpanText from './../../components/SpanText/index';
      ...
      <Layout>
            ...
            <div className="collection__name">
              ...
              <div id="h1" className="collection__header-text">
                <div className="str1">
                  ...
                  >
                    KA<span className="n">ZU</span>KI /
                  </motion.h2>
                  <motion.h1
                    className="fk-h2"
                    initial={{opacity: 0}}
        ...
        <div className="anchors">
          <div>
            ...
            <Anchor to="collection-main" smooth={true} duration={2600}>
              <span className="two">
                <SpanText text="Go to top" />
              </span>
            </Anchor>
            <Link href="https://github.com/abduhamidd/">
              <a className="two">
